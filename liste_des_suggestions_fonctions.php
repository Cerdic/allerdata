...
WHERE (((tbl_est_dans.id_item) In (".$produits.")) AND ((tbl_items_3.id_item) Not In (SELECT distinct  tbl_items_1.id_item FROM tbl_items AS tbl_items_1 INNER JOIN tbl_est_dans ON tbl_items_1.id_item = tbl_est_dans.est_dans_id_item WHERE (((tbl_est_dans.id_item) In (".$produits."))))) AND ((tbl_items_3.id_type_item)=5 Or (tbl_items_3.id_type_item)=13) AND ((tbl_reactions_croisees.fleche_sens1)=1)) OR (((tbl_est_dans.id_item) In (".$produits.")) AND ((tbl_items_3.id_item) Not In (SELECT distinct  tbl_items_1.id_item FROM tbl_items AS tbl_items_1 INNER JOIN tbl_est_dans ON tbl_items_1.id_item = tbl_est_dans.est_dans_id_item WHERE (((tbl_est_dans.id_item) In (".$produits."))))) AND ((tbl_items_3.id_type_item)=5 Or (tbl_items_3.id_type_item)=13) AND ((tbl_reactions_croisees.fleche_sens2)=1)))
