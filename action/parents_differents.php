...
//on liste les produits 1 de la réaction croisée
...
$liste_produits = mysql_query($query_liste_produits, $allerdata) or die(mysql_error());
...
do {
	...
	$liste_parents_produit1 = mysql_query($query_liste_parents_produit1, $allerdata) or die(mysql_error());
	...
	do {
		if ($update != 1) {
			...
			$liste_parents_produit2 = mysql_query($query_liste_parents_produit2, $allerdata) or die(mysql_error());
	...
	if ($update > 0) {
		...
		mysql_query($query_identique, $allerdata) or die(mysql_error());			
	}
	else {
