 ...
 * @return unknown
 */
function autoriser_famille_taxo_supprimer_dist($faire,$quoi,$id,$qui,$options){
 ...
 * @return unknown
 */
function autoriser_famille_taxo_modifier_dist($faire,$quoi,$id,$qui,$options){
 ...
 * @return unknown
 */
function autoriser_famille_taxo_creer_dist($faire,$quoi,$id,$qui,$options){
