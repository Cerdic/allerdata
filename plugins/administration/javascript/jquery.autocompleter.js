...
jQuery.autocomplete = function(input, options) {
	 ...
	 * Fonctions de suppression des espaces surnumŽraires (ou autres caractres)
	 * en dŽbut et en fin de chaine.
	 * trim va faire appel ˆ deux autres mŽthodes rtrim et ltrim qui Žventuellement
	 * restent accessibles individuellement.
	 *
	 * Source :  * http://www.webtoolkit.info/
	 *
	 * @param   {String}  str       Chaine de caractres ˆ traiter.         OBLIGATOIRE
	 * @param   {String}  chars     Chaine ˆ supprimer (par dŽfaut, espace) FACULTATIF
	 * @return  {String}
	 */
